      ...
      <div className="max-w-6xl mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="bg-slate-800/50 p-6 rounded-lg border border-slate-700">
            <h3 className="text-xl font-semibold text-white mb-3">Real-time log aggregation and analysis</h3>
            <p className="text-slate-400">
              Powerful real-time log aggregation and analysis to help it departments and msps succeed.
            </p>
          </div>
          
          <div className="bg-slate-800/50 p-6 rounded-lg border border-slate-700">
            <h3 className="text-xl font-semibold text-white mb-3">Intelligent error pattern detection</h3>
            <p className="text-slate-400">
              Powerful intelligent error pattern detection to help it departments and msps succeed.
            </p>
          </div>
          
          <div className="bg-slate-800/50 p-6 rounded-lg border border-slate-700">
            <h3 className="text-xl font-semibold text-white mb-3">Automated alerting and notifications</h3>
            <p className="text-slate-400">
              Powerful automated alerting and notifications to help it departments and msps succeed.
            </p>
          </div>
        ...
        <div className="text-center bg-slate-800/30 p-12 rounded-lg border border-slate-700">
          ...
          <p className="text-slate-300 text-xl mb-6">
            Starting at just <span className="text-blue-400 font-bold">$99/month</span>
          </p>
        ...
        <footer className="mt-20 pt-8 border-t border-slate-700 text-center text-slate-400">
          <p>&copy; 2026 LogScope. Built with App Factory.</p>
        </footer>
      </div>
    </main>
  );
