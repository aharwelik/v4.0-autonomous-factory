    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-lg border bg-white p-6 shadow-sm">
            <h3 className="text-lg font-semibold text-slate-900">Real-time log aggregation and analysis</h3>
            <p className="mt-2 text-sm text-slate-600">Manage your real-time log aggregation and analysis</p>
            <button className="mt-4 rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700">
              Get Started
            </button>
          </div>
          <div className="rounded-lg border bg-white p-6 shadow-sm">
            <h3 className="text-lg font-semibold text-slate-900">Intelligent error pattern detection</h3>
            <p className="mt-2 text-sm text-slate-600">Manage your intelligent error pattern detection</p>
            <button className="mt-4 rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700">
              Get Started
            </button>
          </div>
          <div className="rounded-lg border bg-white p-6 shadow-sm">
            <h3 className="text-lg font-semibold text-slate-900">Automated alerting and notifications</h3>
            <p className="mt-2 text-sm text-slate-600">Manage your automated alerting and notifications</p>
            <button className="mt-4 rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700">
              Get Started
            </button>
          </div>
